  ...
  return (
    <div className="relative pb-4">
      <div className="relative w-full">
        ...
        <ContactHeroBanner />
        <div className="relative flex items-center justify-center my-8 md:my-12 lg:my-20 z-40 px-4 md:px-6 lg:px-8">
          <div className="relative flex items-center justify-center text-center leading-6 md:leading-8 lg:leading-10 bg-[#F49F3F] rounded-2xl md:rounded-3xl lg:rounded-[30px] text-white font-bold text-sm md:text-lg lg:text-[32px] w-full md:w-[700px] lg:w-[930px] p-4 md:p-5 lg:p-6 ">
            ...
            <img
              className="absolute -top-1 lg:-top-3 left-1 w-4 md:w-12 lg:w-auto"
              src={Yay2}
              alt=""
            />
          </div>
        ...
        <div className="relative container z-40 pb-16! md:pb-24! lg:pb-32!">
          <div className="inline-flex items-center justify-center bg-[#0A4A60] text-white text-xs md:text-sm lg:text-xl font-bold rounded-[5px] px-6 md:px-8 lg:px-12 py-1 mb-4 md:mb-5 lg:mb-6">
            Send us a message
          </div>
          <div className="relative z-40 flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-0">
            <div className="h-full -bg-conic-0 bg-white border border-[#d8d9da5c] rounded-2xl md:rounded-3xl shadow-2xl w-full lg:w-3/4">
              <div className="w-full lg:w-2/3">
                <ContactFormCard />
              </div>
            </div>
            <div className="w-full lg:absolute lg:top-32 lg:right-0 lg:w-1/2">
              <ContactInfoCard />
            </div>
          </div>
        </div>
