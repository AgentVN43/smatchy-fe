...
export default function TeamHeroBanner() {
  return (
    <>
      ...
      >
        <div
          className="absolute inset-0 z-40 bg-[#00000054]" // tương đương #00000054
        ></div>
        <div className="absolute z-50 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 flex flex-col items-center">
